...
def canonicalize_smiles(smiles: str) -> str:
    ...
    """
    return obj.canonicalize_smiles(smiles=smiles)


@mcp.tool()
def check_proposal(smiles: str) -> bool:
    """
    ...
    """
    return obj.check_proposal(smiles=smiles)
...
def get_synthesizability(smiles: str) -> float:
    ...
    """
    return obj.get_synthesizability(smiles=smiles)
...
def verify_smiles(smiles: str) -> bool:
    ...
    """
    return obj.verify_smiles(smiles=smiles)
